...
## 1. QR + mandatory payment screenshot
...
The supplied tool catalog audits to **91 tools**, with all engine dispatch cases and converter exports accounted for by `scripts/audit-tools.mjs`. Tool cards now expose detailed descriptions and the Tools page includes advanced workflow capabilities.
